    ...
    navigation.setOptions({
      headerRight: () =>
        !isEditing ? (
          ...
          >
            <MaterialIcons name="edit" size={22} color="#0094FF" style={{top:-12}} />
          </TouchableOpacity>
        ) : (
          <TouchableOpacity
            ...
            style={{ marginRight: 15 }}
          >
            <AntDesign name="check" size={24} color="#0094FF" style={{top:-12}} />
          </TouchableOpacity>
        ),
    });
  }, [navigation, isEditing, name, email, phone]);
    ...
    <View style={styles.welcomeContainer}>
      <View style={styles.welcomeContent}>
        ...
        <View style={styles.featuresContainer}>
          ...
          <View style={styles.featureItem}>
            <AntDesign name="truck" size={24} color="#0094FF" />
    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileInfo}>
        ...
        <View style={styles.inputFields}>
          ...
          <TextInput style={styles.inputBox} value={name} onChangeText={(text) => { if (validateName(text)) setName(text); }} editable={isEditing} ref={firstInputRef} />

          <Text style={styles.inputLabel}>Email</Text>
          <TextInput style={styles.inputBox} value={email} keyboardType="email-address" onChangeText={handleEmailChange} editable={isEditing} />

          <Text style={styles.inputLabel}>Phone</Text>
          <TextInput style={styles.inputBox} value={phone} keyboardType="phone-pad" onChangeText={(text) => { if (validatePhone(text)) setPhone(text); }} editable={isEditing} />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  welcomeTitle: { fontSize: 28, fontWeight: 'bold', color: '#0077CC', textAlign: "center", marginBottom: 10 },
  welcomeSubtitle: { fontSize: 16, color: '#666', textAlign: "center", marginBottom: 40 },
